 ...
 */
  ...
  #define THERMAL_PROTECTION_PERIOD 80 //240        // Seconds	//Julia 250i
  #define THERMAL_PROTECTION_HYSTERESIS 15 //20     // Degrees Celsius	//Julia 250i
   ...
   * below 2.	
   */	
  #define WATCH_TEMP_PERIOD  160               // Seconds	
 ...
 */	
  ...
  #define THERMAL_PROTECTION_BED_HYSTERESIS     15 //5 // Degrees Celsius	//Julia 250i
  /**	
   * As described above, except for the bed (M140/M190/M303).	
   */	
  #define WATCH_BED_TEMP_PERIOD                80 //120 // Seconds //Julia 250i	
 ...
 */
#define HOTEND_IDLE_TIMEOUT //Julia 250i
...
#define CODEPENDENT_XY_HOMING               // If X/Y can't home without homing Y/X first //Julia 250i
...
#define INPUT_SHAPING_Y	
    ...
    #define SHAPING_FREQ_X  22          // (Hz) The default dominant resonant frequency on the X axis.	
    #define SHAPING_ZETA_X  0.15f       // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping).	
  #endif	
  #if ENABLED(INPUT_SHAPING_Y)	
    #define SHAPING_FREQ_Y  22 //30          // (Hz) The default dominant resonant frequency on the Y axis.	//Julia 250i
...
// @section lcd
  ...
  #define FINE_MANUAL_MOVE 0.025 //0.05    // (mm) Smallest manual move (< 0.1mm) applying to Z on most machines //Julia 250i
  #if IS_ULTIPANEL
...
#define BABYSTEPPING	
  ...
  //#define DOUBLECLICK_FOR_Z_BABYSTEPPING  // Double-click on the Status Screen for Z Babystepping.	
    ...
    #define MOVE_Z_WHEN_IDLE              // Jump to the move Z menu on doubleclick when printer is idle.	
      ...
      #define MOVE_Z_IDLE_MULTIPLICATOR 1//10   // Multiply 1mm by this factor for the move step size.	//Julia 250i
    #endif	
  #endif	
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define Y_CURRENT       1000 //1200	//Julia 250i
    ...
    #define Z_CURRENT       1000 //800	//Julia 250i
    #define Z_CURRENT_HOME  Z_CURRENT	
    #define Z_MICROSTEPS    4//16 //Julia 250i 	
...
//#define CUSTOM_MENU_CONFIG	
  ...
  #define CUSTOM_MENU_CONFIG_TITLE "Factory Settings"	
  #define CUSTOM_MENU_CONFIG_SCRIPT_DONE "Factory Settings Done"	
  #define CUSTOM_MENU_CONFIG_SCRIPT_AUDIBLE_FEEDBACK	
  //#define CUSTOM_MENU_CONFIG_SCRIPT_RETURN  // Return to status screen after a script	
  #define CUSTOM_MENU_CONFIG_ONLY_IDLE        // Only show custom menu when the machine is idle	
  #define CONFIG_MENU_ITEM_1_DESC "Flash Firmware"	
  #define CONFIG_MENU_ITEM_1_GCODE "M997"	
  //#define CONFIG_MENU_ITEM_1_CONFIRM        // Show a confirmation dialog before this action	
  #define CONFIG_MENU_ITEM_2_DESC "Prepare Home Offset"	
  #define CONFIG_MENU_ITEM_2_GCODE "M206 X0 Y0 Z0\nG28\nG1 Z5 F5000\nM211 S0\nM18 X Y"	//Home, move nozzle cloose to bed. THen using move menu, jog Z axis rght to the bed. Then set this as new Z home offset
  //#define CONFIG_MENU_ITEM_2_CONFIRM	
  #define CONFIG_MENU_ITEM_3_DESC "Save Home Offset"	
  #define CONFIG_MENU_ITEM_3_GCODE "M428\nM500\nG28\nM211 S1"	
